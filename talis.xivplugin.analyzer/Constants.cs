...
namespace Talis.XIVPlugin.Analyzer
{
    public static class Constants
    {
        ...
        public const string LibraryPack = "pack://application:,,,/Talis.XIVPlugin.Analyzer;component/";
        ...
        public static XDocument XSettings
        {
            get
            {
                var file = Path.Combine(FFXIVAPP.Common.Constants.PluginsSettingsPath, "Talis.XIVPlugin.Analyzer.xml");
                var legacyFile = "./Plugins/Talis.XIVPlugin.Analyzer/Settings.xml";
                if (_xSettings != null)
                {
                    return _xSettings;
                }
